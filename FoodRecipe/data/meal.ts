...
export const MEALS: Meal[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      'Brush bottom and sides of 2 ramekins lightly with 1 teaspoon melted butter.',
      'Add 1 tablespoon white sugar to ramekins. Rotate to coat all surfaces.',
      'Melt chocolate in a metal mixing bowl over hot water.',
      'Melt 1 tablespoon butter in skillet, stir in flour, whisk in cold milk until smooth and thick.',
      'Combine this mixture with the melted chocolate.',
      'Add salt, cayenne pepper, and egg yolk. Mix to combine.',
      'Whisk egg whites with cream of tartar, gradually add sugar until soft peaks form.',
